...
type Section = { id: string; title: string; durationMinutes: number | null; sortOrder: number; questions: { questionId: string; stem: string; type: string; sortOrder: number }[] };
...
export function TestBuilder({ test, exams, sections, questions, canManage }: { test: TestDetails; exams: Exam[]; sections: Section[]; questions: Question[]; canManage: boolean }) {
