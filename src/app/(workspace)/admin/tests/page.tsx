...
export default async function Page({ searchParams }: { searchParams: Promise<{ exam?: string }> }) {
  const selectedExamId = (await searchParams).exam;
