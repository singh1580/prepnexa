...
import { MaterialCreateForm, MaterialPublishButton, MaterialUploadForm, ProductCreateForm } from "@/features/admin-catalog/ui/forms";
...
export default async function Page() {
  ...
  const [products, materials, exams, items] = await Promise.all([
