...
export default async function Page() {
  ...
  return <WorkspaceShell admin name={auth.user.name} permissions={auth.permissions} section="content">
    ...
    <section className="phase-roadmap"><article><span>01</span><h2>Taxonomy</h2><p>Available now</p></article><article><span>02</span><h2>Question workflow</h2><p>Available now</p></article><article className="muted-card"><span>03</span><h2>Tests & imports</h2><p>Later in Phase 5</p></article></section>
  </WorkspaceShell>;
}
