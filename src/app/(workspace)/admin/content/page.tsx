...
export default async function Page() {
  ...
  return <WorkspaceShell admin name={auth.user.name} permissions={auth.permissions} section="content">
    <header className="page-heading"><span className="eyebrow">CONTENT OPERATIONS</span><h1>Manage your content</h1><p>Manage exams, questions, tests and packages from your admin workspace.</p></header>
    ...
    <section className="phase-roadmap"><article><span>01</span><h2>Taxonomy</h2><p>Available now</p></article><article><span>02</span><h2>Questions</h2><p>Available now</p></article><article><span>03</span><h2>Tests & schedules</h2><p>Available now</p></article><article><span>04</span><h2>Packages & imports</h2><p>Available now</p></article></section>
  </WorkspaceShell>;
}
