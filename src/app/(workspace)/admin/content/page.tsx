...
export default async function Page() {
  ...
  return <WorkspaceShell admin name={auth.user.name} permissions={auth.permissions} section="content">
    ...
    <section className="phase-roadmap"><article><span>01</span><h2>Taxonomy</h2><p>Available now</p></article><article><span>02</span><h2>Questions</h2><p>Available now</p></article><article><span>03</span><h2>Mock tests</h2><p>Available now</p></article><article><span>04</span><h2>Packages & imports</h2><p>Available now</p></article></section>
  </WorkspaceShell>;
}
